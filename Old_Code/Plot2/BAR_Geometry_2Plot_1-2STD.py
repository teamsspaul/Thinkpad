...
C_BarAlpha=0.7              # opacity of "Compare_Bar"
...
PlotSetup = [212,211];LPY = 70;LPX = 30;SS = 1       # Two plots one on top of each other
...
XticksMajor=True                                            # Modify X major ticks?
 ...
 ### In BAR Plot these values are over written ###
...
Xlocs=np.array([10**-8,10**-7,10**-6,10**-5,10**-4,10**-3,  # Locations for labels major
       10**-2,10**-1,10**0,10**1])                          # X ticks I know its lame, 
                                                            # but this has to be a numpy array
...
Ylabel='Percent of ratio cases outside a range of'              # Y label
