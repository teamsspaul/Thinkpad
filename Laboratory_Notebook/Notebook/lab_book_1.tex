...
\labday{Sunday, 9 October 2016\\ 7:00 pm}
...
\item{Prepare for multi contact extraction and back extraction exp}
  ...
  \item{Make sure tweezers are transfered in as well - to remove smaller
...
+\\
4.000+/-0.020 ml of 0.0240+/-0.0010 M Fe(II) in 4.00+/-0.05 M HNO\tsbs{3} solution
\end{center}
