...
\labday{Tuesday, 11 October 2016\\ 9:00 pm - 11:00 pm}
...
\item{Pull out 0.2 from bottom of $\boxed{1}$ (HNO\tsbs{3}),
  dillute to 0.3 ml with 4 M HNO\tsbs{3} $\boxed{\rightarrow 1W}$}
\item{Pull out 0.3 ml from $\boxed{3}$ to count
  $\boxed{\rightarrow 3P}$ (product)}
\item{Pull out 0.3 ml from top of $\boxed{2}$ (TBP), to count
       $\boxed{\rightarrow 2W}$ (Waste)}
\item{Pull out 0.7 ml from top of $\boxed{2}$ (TBP)
