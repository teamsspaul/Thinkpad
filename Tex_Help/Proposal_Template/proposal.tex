...
\noindent{\fontsize{16}{19.2}\selectfont \textbf{Ph.D.
Dissertation Proposal: Paul Mendoza}}
...
\bibliographystyle{plain} % Use the custom nihunsrt bibliography style included with the template
